      ...
      <form action="{{ route('"'"'solicitudes.update'"'"', $solicitud) }}" method="POST">
        ...
        <div class="row g-3">
          <div class="col-md-4">
            ...
            <input type="date" id="fecha_solicitud" name="fecha_solicitud" value="{{ old('"'"'fecha_solicitud'"'"', $solicitud->fecha_solicitud?->format('"'"'Y-m-d'"'"')) }}" class="form-control @error('"'"'fecha_solicitud'"'"') is-invalid @enderror" required>
          ...
          <div class="col-12">
            ...
            <input type="text" id="titulo" name="titulo" class="form-control @error('"'"'titulo'"'"') is-invalid @enderror" value="{{ old('"'"'titulo'"'"', $solicitud->titulo) }}" placeholder="Título de la solicitud">
