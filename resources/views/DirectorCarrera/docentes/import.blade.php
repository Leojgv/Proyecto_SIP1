...
@section('title', 'Cargar Docentes desde Excel')

@section('content')
<div class="dashboard-page">
  <div class="page-header mb-4">
    <div>
      <p class="text-danger text-uppercase fw-semibold small mb-1">Gestion de docentes</p>
      <h1 class="h4 mb-1">Carga de Docentes</h1>
      <p class="text-muted mb-0">Importa multiples docentes desde un archivo Excel.</p>
    </div>
  </div>
    ...
    <div class="col-lg-8">
      <div class="card border-0 shadow-sm mb-4">
        <div class="card-body">
          ...
          <form action="{{ route('director.docentes.import') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="d-flex gap-2">
              <button type="submit" class="btn btn-danger">
                <i class="fas fa-upload me-2"></i>Cargar Docentes
              </button>
              <a href="{{ route('director.docentes') }}" class="btn btn-outline-secondary">
      ...
      <div class="card border-0 shadow-sm">
        <div class="card-body">
          ...
          <div class="mb-3">
            ...
            <ul class="small mb-0">
              <li>Los docentes se asignan automaticamente a las carreras que diriges.</li>
              <li>Si un docente ya existe (por email), se actualiza su informacion y su carrera.</li>
              <li><strong>Todos los docentes importados tendran la contraseña: <code>Inacap.2030</code></strong></li>
            </ul>
          </div>
              ...
              <table class="table table-sm table-bordered mb-0">
                ...
                <tbody>
                  <tr>
                    <td>Maria</td>
                    <td>Gonzalez</td>
                    <td class="text-break">maria.gonzalez@email.com</td>
